...
class BaseService(object):
    ...
    def open_search(self, request, columnIndexNameMap, columnSortIndexNameMap, querySet=None, search=True, extra_response_params={}, *args, **kwargs):

        open_search_data = parse_qs(request.META["QUERY_STRING"])
        sort_prop_name = None
